...
class NTXentLoss(nn.Module):
    ...
    def forward(self, y, y_hat):
        ...
        y_couples = (y_batch.matmul(y_batch.T.contiguous()))/self.temperature
        ...
        y_sim_pos_couples = (F.cosine_similarity(y, y_hat) / self.temperature)
        ...
        # Contrastive accuracy (you may need to implement a custom accuracy metric)
